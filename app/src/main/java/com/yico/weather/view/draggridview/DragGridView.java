package com.yico.weather.view.draggridview;
...
/**
 * Created by ZhaoYidong on 2017/4/10.
 */
public class DragGridView extends GridView implements AdapterView.OnItemLongClickListener {
    ...
    private void initWindow() {
        if (dragView == null) {
            dragView = View.inflate(getContext(), R.layout.item_drag_grid_view, null);
            TextView tv_text = (TextView) dragView.findViewById(R.id.tv_city);
            tv_text.setBackgroundColor(getResources().getColor(R.color.gray));
            tv_text.setText(((TextView) view.findViewById(R.id.tv_city)).getText());
        }
